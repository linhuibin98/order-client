    ...
    <div className='shop_comment_container'>
      ...
      <section className='comment_wrapper'>
        <ul className='tag_box'>
          <li className='tag_item active'>全部 <span>8388</span></li>
          <li className='tag_item'>最新</li>
          <li className='tag_item'>好评 <span>7857</span></li>
          <li className='tag_item'>差评 <span>222</span></li>
          <li className='tag_item'>有图 <span>265</span></li>
          <li className='tag_item'>味道好 <span>22</span></li>
        </ul>
        <ul className='comment_box'>
          <li className='comment_item'>
            <div className='user_avatar'>
              <img src="https://cube.elemecdn.com/1/5e/1a36fbfee957abce3c0e78e7ab905jpeg.jpeg?x-oss-process=image/format,webp/resize,w_51,h_51,m_fixed" alt="用户头像"/>
            </div>
            <div className='comment_content'>
              ...
              <div className='comment_img'>
                <img src="https://cube.elemecdn.com/d/85/df3684b0d656fd08b59a9fbefd4e2jpeg.jpeg?x-oss-process=image/format,webp/resize,w_300" alt="img"/>
              </div>
            </div>
          </li>
          <li className='comment_item'>
